...
path.append(path.dirname(path.dirname(path.dirname(__file__))))

# Import all models to ensure they're registered with SQLAlchemy
# Import database connection utilities
from truck_tickets.database.connection import DatabaseConnection
...
def get_database_url() -> str:
    ...
    if hasattr(DatabaseConnection, "from_env"):
        try:
            db_connection = DatabaseConnection.from_env()
            return db_connection.connection_url
        except Exception:
            pass

    # Fallback to config or default SQLite for development
