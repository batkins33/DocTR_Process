...
class VendorDetector:
    ...
    def __init__(self, vendor_templates: Dict, normalizer: Optional[SynonymNormalizer] = None):
    ...
    def detect(self, text: str, **kwargs) -> Tuple[Optional[str], float]:
        ...
        vendor_keywords = [
            "Waste Management", "WM", "LDI", "Post Oak", "Beck", "NTX", "UTX"
        ]
    ...
    def get_template(self, vendor_name: str) -> Optional[Dict]:
