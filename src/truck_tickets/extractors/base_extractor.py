...
class BaseExtractor(ABC):
    ...
    def __init__(self, vendor_template: Optional[Dict] = None):
    ...
    def extract_from_roi(
        ...
        text: str, 
        roi: Dict[str, int],
        full_page_dimensions: Optional[Tuple[int, int]] = None
    ) -> str:
        ...
        self.logger.debug(f"ROI extraction not yet implemented, using full text")
        return text
