...
class ImageExtractor:
    ...
    def extract_from_bytes(self, data: bytes, filename: str) -> Generator[Image.Image, None, None]:
    ...
    def _extract_from_image(self, image_path: Path) -> Generator[Image.Image, None, None]:
