...
class OCRProcessor:
    ...
    def __init__(
        self, engine_name: str = "doctr", orientation_method: str = "tesseract"
    ):
    ...
    def process_single_page(
        self, image: Image.Image, page_num: int = 1
    ) -> dict[str, Any]:
    ...
    def get_stats(self) -> dict[str, Any]:
        ...
        if stats["total_pages"] > 0:
            stats["avg_time_per_page"] = round(
                stats["total_time"] / stats["total_pages"], 3
            )
        return stats
