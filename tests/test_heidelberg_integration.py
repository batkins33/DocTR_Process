...
from doctr_process.ocr.vendor_utils import HEIDELBERG_FIELDS, extract_vendor_fields
...
def test_heidelberg_vendor_detection():
    ...
    vendor_name, vendor_type, confidence, display_name = detector.detect_vendor(
        test_text
    )
...
def test_heidelberg_output_handler():
    ...
    config = {"output_dir": "./test_outputs", "include_xlsx": True}
    ...
    results = [
        ...
        {"file": "test.pdf", "page": 2, "vendor": "Other", "ticket_number": "789012"},
    ]
