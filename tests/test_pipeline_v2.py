...
class TestRefactoredPipeline:
    ...
    def test_setup_components(self, mock_vendor_rules, mock_extraction_rules, mock_config):
    ...
    def test_process_file_error_handling(self, mock_setup):
        ...
        pipeline.image_extractor.extract_from_bytes.side_effect = Exception("Test error")
