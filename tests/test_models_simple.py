...
import pytest
from src.truck_tickets.models.sql_processing import ProcessingRun, ReviewQueue
from src.truck_tickets.models.sql_reference import (
    Destination,
    Job,
    Material,
    Source,
    ...
    def test_base_class(self):
        ...
        for model_class in [
            ...
            for field in audit_fields:
                assert hasattr(
                    model_class, field
                ), f"{model_class.__name__} missing {field}"
